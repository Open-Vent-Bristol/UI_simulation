class IntMenuItem extends MenuItem {
  int value, max, min, increment;

  IntMenuItem(int _lineIndex, int _startIndex, int _numChars, 
    int _default, int _min, int  _max, int _increment) {
